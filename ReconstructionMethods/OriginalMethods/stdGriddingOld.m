function stdGriddingOld(Kx,Ky,main,class,scan)
    ...
    for step=1:length(a)
        ...
        for i=1:256
            for j=1:256
                   ...
                   z=fineV((a(step)*i)-(a(step)-1):(a(step)*i)+1,(a(step)*j)-(a(step)-1):(a(step)*j)+1);  
                   stdV(i,j)=sum(sum(z))/((a(step)+1)^2);
            end
        end
