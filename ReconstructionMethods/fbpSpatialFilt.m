function imageMat = fbpSpatialFilt(Kx,Ky,main,class,scan)
%This is the filtered back projection function with spatial filtering for the Oakland Toolbox.
%It is recommended for the AVIIIHD scans instead of the standard filtered back
%projection function.
...
if length(Kx) == 131
    ...
    imageMat = imageMat./fil;
    imageMat(imageMat==inf)=0;
